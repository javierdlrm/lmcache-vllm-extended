...
with st.sidebar:
    ...
    singlechat = multichat_session.MultiChatSession(IP1, PORT1)
    print("NEW SINGLECHAT")
    session = singlechat.init_chat()
    ...
    # multichat = multichat_session.MultiChatSession(IP1, PORT1)
    # print("NEW MULTICHAT")
    ...
    #             messages.chat_message("user").write(prompt)
    #             messages.chat_message("assistant").write_stream(chat.chat(prompt))
